...
import { postTickerSearch } from '../../lib/market/marketApi.js'
...
/** @param {{ onCreated?: () => void, prefilledSymbol?: string, sharesightHoldingExternalId?: string|null }} props */
export function AddTickerCombobox({ onCreated, prefilledSymbol = '', sharesightHoldingExternalId = null }) {
  ...
  async function createPosition(hit) {
  ...
  return (
    <div className="relative rounded-xl border border-[rgba(255,255,255,0.06)] bg-[#111118] px-4 py-4">
      ...
      {creating ? (
        <p className="mt-3 font-mono text-[10px] uppercase tracking-wide text-[#F59E0B]">Creating row</p>
      ) : null}
    </div>
  )
}
